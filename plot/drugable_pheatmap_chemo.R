...
save_svg(tabNew, "./drug_mut_heatmap_chemonaive.pdf", gene_order)

tabNew = tab[gene %in% genes & Both_treated=="Metastasis_treated"]
save_svg(tabNew, "./drug_mut_heatmap_metastasis_treated.pdf", gene_order)

tabNew = tab[gene %in% genes & Both_treated=="Both_treated"]
save_svg(tabNew, "./drug_mut_heatmap_both_treated.pdf", gene_order)
