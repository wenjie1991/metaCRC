...
getSampMutMulti <- function(samples, normal, d, cmedianTh, original) {
    ...
    if (! is.na(caddindex)) {
        ...
        res = d[rindex,c(1,2,3,4,5,cindex,gnindex,glindex,gfindex,caddindex,gerpindex,siftindex,polyphenindex,somindex,ncindex)]
    } else {
        #         res = d[rindex,c(1,2,3,4,5,cindex,gnindex,glindex,gfindex,dronindex,somindex,ncindex)]
        res = d[rindex,c(1,2,3,4,5,cindex,gnindex,glindex,gfindex,somindex,ncindex)]
    }
...
adjust.ccf.titan.multi <- function(sampAB, samples, t, titanPath="./titan/", correctColname=FALSE, overadj=1.6, sigTh=0.9) {
    ...
    return(list(sampAB = sampAB, purities = purities))
}
